...
export const DEMO_STORIES: DemoStory[] = [
  {
    ...
    talkingPoints: [
      ...
      "Profitability score lands in AVOID territory — dispatcher is warned before accepting",
    ],
  ...
  },
  {
    ...
    outcome: "FleetOS marks the load RECOMMENDED with a strong profitability score.",
    talkingPoints: [
      ...
      "Profitability score lands comfortably in RECOMMENDED territory",
    ],
